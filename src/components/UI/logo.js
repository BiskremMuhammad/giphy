...
const logo = () => (
	<svg className={styles.AppLogo} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 164 35" itemProp="logo">
		<g fillRule="evenodd" clipRule="evenodd">
			<path className={styles.LogoP1} d="M0 3h4v29H0z"></path>
			<path className={styles.LogoP2} d="M24 11h4v21h-4z"></path>
			<path className={styles.LogoP3} d="M0 31h28v4H0z"></path>
			<path className={styles.LogoP4} d="M0 0h16v4H0z"></path>
			<path className={styles.LogoP5} d="M24 8V4h-4V0h-4v12h12V8"></path>
			<path className={styles.LogoP6} d="M24 16v-4h4M16 0v4h-4"></path>
		</g>
